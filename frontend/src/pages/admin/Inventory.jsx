  ...
  return (
    <div>
      ...
      <div className="card" style={{ padding: 40, textAlign: 'center' }}>
        ...
        <h2 style={{ fontFamily: 'Poppins', fontSize: 22, fontWeight: 700, marginBottom: 12 }}>Inventory</h2>
        <p style={{ color: 'var(--text-secondary)', maxWidth: 400, margin: '0 auto 24px', lineHeight: 1.7 }}>Manage spare parts stock and vendors.</p>
